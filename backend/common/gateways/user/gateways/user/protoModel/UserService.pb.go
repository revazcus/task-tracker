...
type User struct {
	...
	Created_At    int64                  `protobuf:"varint,7,opt,name=created_At,json=createdAt,proto3" json:"created_At,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *User) GetCreated_At() int64 {
	if x != nil {
		return x.Created_At
	}
	return 0
...
var file_UserService_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x19, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x75, 0x73, 0x65, 0x72,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0x1d,
	0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a,
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0xb7, 0x01,
	...
	,
...
var file_UserService_proto_goTypes = []any{
	(*UserRequest)(nil), // 0: common.userService.schema.UserRequest
	(*User)(nil),        // 1: common.userService.schema.User
}
var file_UserService_proto_depIdxs = []int32{
	0, // 0: common.userService.schema.UserService.GetUser:input_type -> common.userService.schema.UserRequest
	1, // 1: common.userService.schema.UserService.GetUser:output_type -> common.userService.schema.User
